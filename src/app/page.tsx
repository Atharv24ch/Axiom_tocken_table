...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0b0d] text-white" suppressHydrationWarning>
      {/* Top Navigation - Exact Axiom Copy */}
      <nav className="border-b border-gray-800 px-6 py-3" suppressHydrationWarning>
        <div className="flex items-center justify-between" suppressHydrationWarning>
          ...
          <div className="flex items-center gap-3" suppressHydrationWarning>
            ...
            <div className="flex items-center gap-2 px-3 py-1.5 bg-gray-800 rounded-lg text-sm" suppressHydrationWarning>
            ...
            <button className="p-2 hover:bg-gray-800 rounded-lg text-sm">🔔</button>
            <div className="flex items-center gap-1.5 px-3 py-1.5 bg-gray-800 rounded-lg text-sm" suppressHydrationWarning>
              <span>💰</span>
              <span>0</span>
            </div>
            <button className="p-2 hover:bg-gray-800 rounded-lg text-sm">👤</button>
      ...
      <div className="border-b border-gray-800" suppressHydrationWarning>
        <div className="flex items-center justify-between px-6 py-3" suppressHydrationWarning>
